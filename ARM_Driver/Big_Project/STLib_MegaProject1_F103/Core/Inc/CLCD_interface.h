...
typedef struct 
{
	GPIO_TypeDef **DataPorts;	/* Ports must be at this order: D0, D1, D2, D3, D4, D5, D6, D7. From D4 to D7 if 4-bit mode is used */
	GPIO_TypeDef **CtrlPorts;	/* Ports must be at this order: RS, R/W, EN                                                         */
    uint16_t *DataPins;			/* Pins must be at this order: D0, D1, D2, D3, D4, D5, D6, D7. From D4 to D7 if 4-bit mode is used  */
    uint16_t *CtrlPins;			/* Pins must be at this order: RS, R/W, EN                                                          */
    CLCD_Mode_t Mode;
} CLCD_Config_t;
